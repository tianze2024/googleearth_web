...
{
    icon: require("../../img/openLayers.png"),
    title: '默认Openlayers场景',
    func: () => {
        setDefaultScene('openLayers')
    }
},
{
    icon: require("../../img/czm&ol.png"),
    title: '默认Openlayers&Cesium场景',
    func: () => {
        setDefaultScene('openLayers&cesium')
    }
},
{
